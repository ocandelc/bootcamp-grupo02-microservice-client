 ...
 * Descripción              : Clase para los métodos de la implemetnación de servicio del tipo de cliente.
...
/**
 * Clase para los métodos de la implemetnación de servicio del tipo de cliente.
 */
@Service
